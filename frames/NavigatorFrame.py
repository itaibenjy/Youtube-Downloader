...
class NavigatorFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, app) -> None:
        ...
        self.title = customtkinter.CTkLabel(self, text="YD", font=customtkinter.CTkFont(size=30, weight="bold"))
        self.title.grid(row=0, column=0, padx=10, pady=40)

        # Navigation Buttons 
        self.search = customtkinter.CTkButton(self, corner_radius=0, height=BUTTON_HEIGHT, border_spacing=10, text="",
        ...
        self.url = customtkinter.CTkButton(self, corner_radius=0, height=BUTTON_HEIGHT, border_spacing=10, text="",
        ...
        self.downloading = customtkinter.CTkButton(self, corner_radius=0, height=BUTTON_HEIGHT, border_spacing=10, text="",
                                              width= 60, fg_color="transparent", text_color=TEXT_COLOR, hover_color=HOVER_COLOR,
        ...
        self.settings = customtkinter.CTkButton(self, corner_radius=0, height=BUTTON_HEIGHT, border_spacing=10, text="",
                                              width= 60, fg_color="transparent", text_color=TEXT_COLOR, hover_color=HOVER_COLOR,
